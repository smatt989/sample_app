...
describe UsersController do
  ...
  describe "GET 'index'" do
  	...
  	describe "for signed-in users" do
  		before(:each) do
  			...
  			theird = FactoryGirl.create(:user, :email => "another@example.com")
  ...
  describe "GET 'edit'" do
	  ...
	  it "should have a link to change the Gravatar" do
	  	...
	  	response.body.should have_selector("a", :href => gravatar_url, :content => "change")
	  end
  end
  ...
  describe "DELETE 'destroy'" do
  	...
  	describe "as an admin user" do
  		before(:each) do
  			admin = FactoryGirl.create(:user, :email => "admin@exmaple.com", :admin => true)
  			test_sign_in(admin)
  		end
